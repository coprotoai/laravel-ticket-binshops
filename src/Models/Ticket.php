...
class Ticket extends Model
{
    ...
    {
        return $this->belongsTo('Binshops\LaravelTicket\Models\Status', 'status_id');
    }
    ...
    {
        return $this->belongsTo('Binshops\LaravelTicket\Models\Priority', 'priority_id');
    }
    ...
    {
        return $this->belongsTo('Binshops\LaravelTicket\Models\Category', 'category_id');
    }
    ...
    {
        return $this->belongsTo('Binshops\LaravelTicket\Models\Agent', 'agent_id');
    }
    ...
    {
        return $this->hasMany('Binshops\LaravelTicket\Models\Comment', 'ticket_id');
    }
...
//    /**
    ...
    //    {
    //        return $this->hasMany('Binshops\LaravelTicket\Models\Audit', 'ticket_id');
    //    }
    //
