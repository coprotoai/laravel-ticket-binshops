...
namespace Binshops\LaravelTicket\Seeds;
...
class SettingsTableSeeder extends Seeder
{
    ...
    /**
     * Takes config/laravelticket.php, merge with package defaults, and returns serialized array.
     *
     * @param $defaults
     * @param $config
     *
    ...
    public function getDefaults()
    {
        return [
            ...
            /*
             * LaravelTicket main route: Where to load the ticket system (ex. http://url/tickets)
             * Default: /ticket
             */
            'main_route'      => 'tickets',
            'main_route_path' => 'tickets',
            /*
             * LaravelTicket admin route: Where to load the ticket administration dashboard (ex. http://url/tickets-admin)
             * Default: /ticket
             */
             ...
             * Default: laravelticket::emails.templates.laravelticket
             */
            'email.template' => 'laravelticket::emails.templates.laravelticket',
            // resources/views/emails/templates/laravelticket.blade.php
            ...
            'email.footer'           => 'Powered by LaravelTicket',
            'email.footer_link'      => 'https://github.com/binshops/laravel-ticket',
...
//            'admin_ids' => [1],
            ...
            /*
             * If Font-awesome css is included outside laravel-ticket, this should be set to 'no'
             * Default: 'yes'
             */
             ...
             */
            'summernote_options_json_file' => 'vendor/coprotoai/laravel-ticket/src/JSON/summernote_init.json',
             ...
             *
             * Useful if you want to replace any of the LaravelTicket components
             *
             * Default: __DIR__.'/routes.php'
             */
            'routes' => base_path('vendor/coprotoai/laravel-ticket/src').'/routes.php',
